...
namespace Inergy.Indev3.BusinessLogic.Upload
{
    ...
    public class Imports : GenericEntity, IImports
    {
        ...
        private bool _skipCostCentersWithoutHourlyRateError;
        public bool SkipCostCentersWithoutHourlyRateError
        {
            get { return _skipCostCentersWithoutHourlyRateError; }
            set { _skipCostCentersWithoutHourlyRateError = value; }
        }
        ...
        public int InsertToActualTable(string fileName, int IDAssociate, int IDImport, bool skipCostCentersWithoutHourlyRateError)
        {
            ...
            try
            {
                ...
                this.SkipCostCentersWithoutHourlyRateError = skipCostCentersWithoutHourlyRateError;
