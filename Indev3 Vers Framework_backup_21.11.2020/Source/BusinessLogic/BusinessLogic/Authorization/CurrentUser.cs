...
namespace Inergy.Indev3.BusinessLogic.Authorization
{
    ...
    public class CurrentUser : GenericEntity
    {
        ...
        {
            get { return _IdProjectFunctionImpersonated; }
            set { _IdProjectFunctionImpersonated = value; }
        }

        private int _IdProjectImpersonated;
        public int IdProjectImpersonated
        {
            get { return _IdProjectImpersonated; }
            set { _IdProjectImpersonated = value; }
        }
        ...
        public CurrentUser Clone()
        {
            ...
            newUser.IdProjectFunctionImpersonated = this.IdProjectFunctionImpersonated;
        ...
        private Permissions GetNonRolePermissions(IndPair moduleOperation, int idProject)
        {
         ...
         public bool IsCurrentUserImpersonatingSomeoneOnProject(int idProject)
         {
             return DBCurrentUser.IsCurrentUserImpersonatingSomeoneOnProject(idProject, this.IdAssociate, this.IdImpersonatedAssociate);
         }

         public bool IsCurrentUserImpersonatingProgramManagerOnProject(int idProject)
         {
             return DBCurrentUser.IsCurrentUserImpersonatingProgramManagerOnProject(idProject, this.IdAssociate, this.IdImpersonatedAssociate);
         }
