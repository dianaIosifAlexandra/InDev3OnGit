...
namespace Inergy.Indev3.BusinessLogic.AnnualBudget
{
    public class AnnualUpload : GenericEntity,IAnnualUpload
    {
        ...
        private bool _skipStartEndPhaseErrorsHours;
        public bool SkipStartEndPhaseErrorsHours
        {
            get { return _skipStartEndPhaseErrorsHours; }
            set { _skipStartEndPhaseErrorsHours = value; }
        }

        private bool _skipStartEndPhaseErrorsCosts;
        public bool SkipStartEndPhaseErrorsCosts
        {
            get { return _skipStartEndPhaseErrorsCosts; }
            set { _skipStartEndPhaseErrorsCosts = value; }
        }

        private bool _skipStartEndPhaseErrorsSales;
        public bool SkipStartEndPhaseErrorsSales
        {
            get { return _skipStartEndPhaseErrorsSales; }
            set { _skipStartEndPhaseErrorsSales = value; }
        }
        ...
        public int InsertIntoAnnualTable(bool skipStartEndPhaseErrorsHours, bool skipStartEndPhaseErrorsCosts, bool skipStartEndPhaseErrorsSales)
        {
            int result = ApplicationConstants.INT_NULL_VALUE;           
            try
            {
                this.SkipStartEndPhaseErrorsHours = skipStartEndPhaseErrorsHours;
                this.SkipStartEndPhaseErrorsCosts = skipStartEndPhaseErrorsCosts;
                this.SkipStartEndPhaseErrorsSales = skipStartEndPhaseErrorsSales;
                this.BeginTransaction();
