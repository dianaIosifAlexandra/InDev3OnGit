...
namespace Inergy.Indev3.BusinessLogic.Budget
{
    public class RevisedBudget : Budget, IRevisedBudget
    {
        ...
        public object GetLastValidatedVersion()
        {
            ...
            try
            {
                result = this.GetEntity().ExecuteScalar("bgtGetLastValidatedRevisedVersion", this);
            }
            catch (Exception exc)
            {
                throw new IndException(exc);
        ...
        public int Unvalidate()
        {
            ...
            try
            {
                result = this.GetEntity().ExecuteCustomProcedure("bgtUnvalidateLastRevisedVersion", this);
            }
            catch(Exception ex)
            {
                throw new IndException(ex);
        ...
        public bool IsOpen()
        {
            ...
            try
            {
                result = Convert.ToBoolean(this.GetEntity().ExecuteCustomProcedureWithReturnValue("bgtIsLastRevisedVersionOpen", this));
            }
            catch (Exception ex)
            {
                throw new IndException(ex);
