IF EXISTS (SELECT * FROM dbo.sysobjects WHERE ID = object_id(N'[dbo].[OLAP_CURRENCIES_PROGRAM_FUNCTIONS]') and OBJECTPROPERTY(id, N'IsView') = 1)
DROP VIEW OLAP_CURRENCIES_PROGRAM_FUNCTIONS
GO

CREATE VIEW OLAP_CURRENCIES_PROGRAM_FUNCTIONS
AS

SELECT	DISTINCT
 	PRJ.IdProgram 	AS IdProgram,
	CURR.Id 	AS IdCurrency
FROM	OLAP_FUNCTIONS_DATA OAD
