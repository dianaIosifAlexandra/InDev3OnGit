...
namespace Inergy.Indev3.ApplicationFramework
{
    ...
    public static class ApplicationMessages
    {
        ...
        public const string EXCEPTION_TRACKING_ACTIVITY_LOG_INCOMPLETE_PROPERTIES = "Internal error. The Tracking Activity Log object does not have the neccessary properties set.";
        ...
        public const string IMPORT_FILE_CC_WITHOUT_HR = "File: {0} was not yet imported. There are Cost Centers without hourly rate. Click the associated link for details.<BR>If you want to process the file, please click 'Process' buton again.";
        public const string IMPORT_FILE_INITIAL_BUDGET_ERROR = "File: {0} was NOT successfully imported. {1}";
        public const string IMPORT_FILE_REVISED_BUDGET_ERROR = "File: {0} was NOT successfully imported. {1}";
        ...
        public const string UPLOAD_SUCCESSFULY_BUDGET_REVISED = "File succesfully uploaded with id {0}. Press 'Process' to continue.";
        ...
        public const string REVISED_IMPORT_WRONG_FILE_FORMAT = "The file: {0} you are trying to upload does not have the correct format RevisedBudget[ProjectCode](eg. RevisedBudgetW1 ).";
