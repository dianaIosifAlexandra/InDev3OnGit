...
namespace Inergy.Indev3.DataAccess.Authorization
{
    ...
    public class DBCurrentUser : DBGenericEntity
    {
        ...
        public bool IsCurrentUserImpersonatingSomeoneOnProject(int idProject, int idAssociate, int idImpersonated)
        {
            bool result = false;
            SqlCommand command = new SqlCommand();
            command.CommandType = CommandType.StoredProcedure;
            command.CommandText = "authIsAssociateKeyUserImpersonatingOnProject";
