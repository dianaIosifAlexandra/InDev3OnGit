    ...
    public class DBHourlyRate : DBGenericEntity
    {
        ...
        protected override void InitializeObject(IGenericEntity ent)
        {
            if (ent is IHourlyRate)
            {
                ...
                DBStoredProcedure spGetByYearMonthAndCostCenterCode = new DBStoredProcedure();
                spGetByYearMonthAndCostCenterCode.ProcedureName = "catGetHourlyRateByYearMonthAndCostCenterCode";
                spGetByYearMonthAndCostCenterCode.AddParameter(new DBParameter("StartYearMonth", DbType.Int32, ParameterDirection.Input,
                    (HourlyRate.StartYearMonth == ApplicationConstants.INT_NULL_VALUE) ? (object)DBNull.Value : (object)HourlyRate.StartYearMonth));
                spGetByYearMonthAndCostCenterCode.AddParameter(new DBParameter("EndYearMonth", DbType.Int32, ParameterDirection.Input,
                ...
                spGetByYearMonthAndCostCenterCode.AddParameter(new DBParameter("CostCenterCode", DbType.String, ParameterDirection.Input, HourlyRate.CostCenterCode));
                this.AddStoredProcedure("catGetHourlyRateByYearMonthAndCostCenterCode", spGetByYearMonthAndCostCenterCode);
