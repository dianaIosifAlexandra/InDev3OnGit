    ...
    public class DBReforecastBudget : DBGenericEntity
    {
        ...
        protected override void InitializeObject(IGenericEntity ent)
        {
            if (ent is IReforecastBudget)
            {
                ...
                spGetSalesData.AddParameter(new DBParameter("@IdCurrencyDisplay", DbType.Int32, ParameterDirection.Input, reforecastBudget.IdCurrency));
                ...
                spGetValHoursData.AddParameter(new DBParameter("@IdCurrencyDisplay", DbType.Int32, ParameterDirection.Input, reforecastBudget.IdCurrency));
                ...
                spGetOtherCostsData.AddParameter(new DBParameter("@IdCurrencyDisplay", DbType.Int32, ParameterDirection.Input, reforecastBudget.IdCurrency));
                ...
                spGetGrossCostsData.AddParameter(new DBParameter("@IdCurrencyDisplay", DbType.Int32, ParameterDirection.Input, reforecastBudget.IdCurrency));
                ...
                spGetNetCostsData.AddParameter(new DBParameter("@IdCurrencyDisplay", DbType.Int32, ParameterDirection.Input, reforecastBudget.IdCurrency));
                ...
                DBStoredProcedure spGetLastValidatedReforecastVersion = new DBStoredProcedure();
                spGetLastValidatedReforecastVersion.ProcedureName = "bgtGetLastValidatedReforecastVersion";
                spGetLastValidatedReforecastVersion.AddParameter(new DBParameter("@IdProject", DbType.Int32, ParameterDirection.Input, reforecastBudget.IdProject));
                this.AddStoredProcedure("bgtGetLastValidatedReforecastVersion", spGetLastValidatedReforecastVersion);

                DBStoredProcedure spUnvalidateReforecastVersion = new DBStoredProcedure();
                spUnvalidateReforecastVersion.ProcedureName = "bgtUnvalidateLastReforecastVersion";
                spUnvalidateReforecastVersion.AddParameter(new DBParameter("@IdProject", DbType.Int32, ParameterDirection.Input, reforecastBudget.IdProject));
                this.AddStoredProcedure("bgtUnvalidateLastReforecastVersion", spUnvalidateReforecastVersion);

                DBStoredProcedure spIsLastToCompletionVersionOpen = new DBStoredProcedure();
                spIsLastToCompletionVersionOpen.ProcedureName = "bgtIsLastToCompletionVersionOpen";
                spIsLastToCompletionVersionOpen.AddParameter(new DBParameter("@IdProject", DbType.Int32, ParameterDirection.Input, reforecastBudget.IdProject));
                this.AddStoredProcedure("bgtIsLastToCompletionVersionOpen", spIsLastToCompletionVersionOpen);
