    ...
    public class DBRevisedBudget : DBGenericEntity
    {
        ...
        protected override void InitializeObject(IGenericEntity ent)
        {
            if (ent is IRevisedBudget)
            {
                ...
                spGetRevisedBudgetHours.AddParameter(new DBParameter("@IdCurrencyDisplay", DbType.Int32, ParameterDirection.Input, revisedBudget.IdCurrency));
                ...
                spGetRevisedBudgetCosts.AddParameter(new DBParameter("@IdCurrencyDisplay", DbType.Int32, ParameterDirection.Input, revisedBudget.IdCurrency));
                ...
                DBStoredProcedure spGetLastValidatedRevisedVersion = new DBStoredProcedure();
                spGetLastValidatedRevisedVersion.ProcedureName = "bgtGetLastValidatedRevisedVersion";
                spGetLastValidatedRevisedVersion.AddParameter(new DBParameter("@IdProject", DbType.Int32, ParameterDirection.Input, revisedBudget.IdProject));
                this.AddStoredProcedure("bgtGetLastValidatedRevisedVersion", spGetLastValidatedRevisedVersion);

                DBStoredProcedure spUnvalidateRevisedVersion = new DBStoredProcedure();
                spUnvalidateRevisedVersion.ProcedureName = "bgtUnvalidateLastRevisedVersion";
                spUnvalidateRevisedVersion.AddParameter(new DBParameter("@IdProject", DbType.Int32, ParameterDirection.Input, revisedBudget.IdProject));
                this.AddStoredProcedure("bgtUnvalidateLastRevisedVersion", spUnvalidateRevisedVersion);

                DBStoredProcedure spIsLastRevisedVersionOpen = new DBStoredProcedure();
                spIsLastRevisedVersionOpen.ProcedureName = "bgtIsLastRevisedVersionOpen";
                spIsLastRevisedVersionOpen.AddParameter(new DBParameter("@IdProject", DbType.Int32, ParameterDirection.Input, revisedBudget.IdProject));
                this.AddStoredProcedure("bgtIsLastRevisedVersionOpen", spIsLastRevisedVersionOpen);
            }
        }
    }
}
