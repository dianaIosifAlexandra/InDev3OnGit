...
msbuild.exe /nologo "%SOURCE_DIR%\Framework\ApplicationFramework\ApplicationFramework.csproj" /t:Build /p:Configuration=Debug
if errorlevel 1 goto err

msbuild.exe /nologo "%SOURCE_DIR%\Entities\Entities.csproj" /t:Build /p:Configuration=Debug
if errorlevel 1 goto err

msbuild.exe /nologo "%SOURCE_DIR%\DataAccess\DataAccess\DataAccess.csproj" /t:Build /p:Configuration=Debug
if errorlevel 1 goto err

msbuild.exe /nologo "%SOURCE_DIR%\BusinessLogic\BusinessLogic\BusinessLogic.csproj" /t:Build /p:Configuration=Debug
if errorlevel 1 goto err

msbuild.exe /nologo "%SOURCE_DIR%\Framework\WebFramework\WebFramework.csproj" /t:Build /p:Configuration=Debug
if errorlevel 1 goto err

copy "%SOURCE_DIR%\Bin" "%SOURCE_DIR%\Indev3WebSite\Indev3WebSite\Bin"

msbuild.exe /nologo "%SOURCE_DIR%\Indev3WebSite\Indev3WebSite.sln" /t:Build /p:Configuration=Debug
if errorlevel 1 goto err

REM Build unit tests
msbuild.exe /nologo "%SOURCE_DIR%\Framework\UnitTests\ApplicationFrameworkTests\ApplicationFrameworkTests.csproj" /t:Build /p:Configuration=Debug
if errorlevel 1 goto err

msbuild.exe /nologo "%SOURCE_DIR%\DataAccess\UnitTests\DataAccessTests\DataAccessTests.csproj" /t:Build /p:Configuration=Debug
if errorlevel 1 goto err

msbuild.exe /nologo "%SOURCE_DIR%\BusinessLogic\UnitTests\BusinessLogicTests\BusinessLogicTests.csproj" /t:Build /p:Configuration=Debug
if errorlevel 1 goto err
...
:err
  echo   ******************************************************************************
  echo      Build All has encountered an error!
  echo   ******************************************************************************
  echo Build All was NOT completed.
  goto batchfail
