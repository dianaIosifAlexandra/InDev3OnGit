<%@ control language="C#" autoeventwireup="true" inherits="UserControls_Budget_ProjectCoreTeamMember_ProjectCoreTeamMemberEdit, App_Web_x2wxkadj" %>
...
<cc1:GenericEditControl ID="ProjectCoreTeamMemberEditControl" runat="server">
    <table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td align="left" valign="bottom">
                <asp:Label ID="lblEmpty" runat="server" ForeColor="#626262" Text="&nbsp;" CssClass="foreColorIE"></asp:Label>
        ...
        <tr id="trImpersonate" runat="server">
            <td align="right">
                <cc2:IndCatLabel ID="lblImpersonate" runat="server" CssClass="IndLabel">Impersonate</cc2:IndCatLabel>&nbsp;
            </td>
            <td align="left">
                &nbsp;<cc2:IndCatCheckBox ID="chkImpersonate" runat="server" Checked="False" EnabledOnNew="False" 
                EntityProperty="IsImpersonated" /></td>
        </tr>
