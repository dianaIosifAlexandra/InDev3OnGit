<%@ control language="C#" autoeventwireup="true" inherits="Inergy.Indev3.UI.UserControls_UserSettings_UserSettings, App_Web_f22hpzwk" %>
            ...
            <asp:Panel ID="pnlUserSettings" runat="server" CssClass="Panel">
                <table cellpadding="2" cellspacing="0" border="0" align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            <cc1:IndLabel ID="IndLabel1" runat="server" CssClass="IndLabel" ForeColor="Yellow">*</cc1:IndLabel>
                        </td>
                        <td align="left">
                            ...
                            <table cellspacing="0">
                                <tr>
                                    ...
                                    <td style="padding-left: 8px">
                                        <asp:Button ID="btnChangeCountry" runat="server" Text="Change" PostBackUrl="~/Pages/UserSettings/UserSettings.aspx?Code=UST&ChangeCountry=1"
                                            OnClick="btnChangeCountry_Click" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center" colspan="3">
                            <asp:Button ID="btnSaveConfiguration" Text="Save configuration" runat="server" OnClientClick="ClearUserSettingsDirtyFlag();"
                                OnClick="btnSaveConfiguration_Click" ValidationGroup="UserSettingsValidationGroup" />
                        </td>
                    </tr>
                    <tr>
