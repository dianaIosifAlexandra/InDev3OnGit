...
<%@ page language="C#" enableeventvalidation="false" autoeventwireup="true" inherits="UserControls_Catalogs_HourlyRate_HRMassAttribution, App_Web_tipncokx" %>
...
<body onload="SetOnBeforeUnload(); EnableControls();SetColorDependingOnIE();" style="background: #626262 url('../../../Images/back_popup.png') no-repeat right bottom;" class="backgroundColorIE">
