<%@ control language="C#" autoeventwireup="true" inherits="UserControls_Country_CountryEdit, App_Web_cfyivrrv" %>
        ...
        <tr>
            ...
            <td align="left">
                <cc3:IndCatTextBox ID="txtEmail" runat="server" EntityProperty="Email" Width="150px">
                    ...
                    ForeColor="#626262" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" CssClass="foreColorIE">*</asp:RegularExpressionValidator></td>
        </tr>
         <tr>
            <td align="right">
