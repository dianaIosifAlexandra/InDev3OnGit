<%@ control language="C#" autoeventwireup="true" inherits="Inergy.Indev3.UI.UserControls_Menus_MainMenu, App_Web_ph3dgb0d" %>
    ...
    <Items>
        ...
        <indControl:IndMenuItem runat="server" Text="Data Upload">
            <Items>
                ...
                <indControl:IndMenuItem Text="Revised Budget" runat="server" CssClass="l1center">
                    <Items>
                        <indControl:IndMenuItem runat="server" ModuleCode="RBU" Value="mnuRevisedBudget" Text="Upload" Id="RadMenuItem52" 
                        CssClass="l1center_only" NavigateUrl="~/Pages/UploadRevisedBudget/UploadRevisedBudget.aspx">
                        </indControl:IndMenuItem>
                    </Items>
                </indControl:IndMenuItem>
                ...
                <indControl:IndMenuItem Text="Annual Budget" runat="server" CssClass="l1right">
                    <Items>
                        <indControl:IndMenuItem runat="server" ModuleCode="AND" Text="Download" ID="RadMenuItem14"
                            CssClass="l1left" NavigateUrl="~/Pages/AnnualBudget/AnnualDownload.aspx" Visible="false"> <%--no longer user--%>
                        </indControl:IndMenuItem>
            ...
            <GroupSettings Flow="Horizontal" OffsetX="-170"></GroupSettings>
        </indControl:IndMenuItem>
        <indControl:IndMenuItem runat="server" Text="Extract">
            <Items>
                <indControl:IndMenuItem runat="server" Text="Criteria" ID="IndMenuItem3" CssClass="l1left">
                    <Items>
                ...
                <indControl:IndMenuItem runat="server" ModuleCode="TKD" Text="Tracking Data" ID="RadMenuItem50"
                    CssClass="l1right" NavigateUrl="~/Pages/Extract/ExtractTrackingData.aspx">
                </indControl:IndMenuItem>
            </Items>
            <GroupSettings Flow="Horizontal"  OffsetX="-55"></GroupSettings>
        </indControl:IndMenuItem>
