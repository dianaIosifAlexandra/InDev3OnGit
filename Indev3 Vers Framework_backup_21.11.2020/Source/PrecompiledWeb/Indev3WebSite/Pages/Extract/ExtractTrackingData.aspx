<%@ page language="C#" masterpagefile="~/Template.master" autoeventwireup="true" inherits="Inergy.Indev3.UI.Pages_Extract_ExtractTrackingData, App_Web_rzrjdajc" title="INDev 3" %>
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="2">
                            <ind:IndCatComboBox ID="cmbRole" runat="server" AutoPostBack="false" Width="300px" CheckDirty="false">
                                <Items>
                                    <radCb:radcomboboxitem runat="server" text="" value="-1"></radCb:radcomboboxitem>
                                    <radCb:radcomboboxitem runat="server" text="Business Administrator" value="1"></radCb:radcomboboxitem>
                                    <radCb:radcomboboxitem runat="server" text="Key User" value="8"></radCb:radcomboboxitem>
                                </Items>
                            </ind:IndCatComboBox>
                        </td>
                    </tr>
