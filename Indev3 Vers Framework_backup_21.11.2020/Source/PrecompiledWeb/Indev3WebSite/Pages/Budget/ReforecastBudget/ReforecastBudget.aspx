<%@ page language="C#" masterpagefile="~/Template.master" autoeventwireup="true" inherits="Pages_Budget_ReforecastBudget_ReforecastBudget, App_Web_pgrno1ra" title="INDev3" enableeventvalidation="false" enableviewstate="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ph" runat="Server">
    ...
    function AmountScaleComboChange(item)
    {
        ...
        {
            controlCmbCurrency = <%= cmbCurrency.ClientID%>;
        }
        var controlCmbCurrency = null;

        if (controlCmbCurrency != null &&  controlCmbCurrency.SelectedItem != null)
        {
            url = url + "DisplayedData=" + cmbDisplayedData.SelectedItem.Value + "&AmountScale=" + item.Value +
					"&ShowCCsWithValues=" + cmbShowCCsWithSignificantValues.SelectedItem.Value +
					"&IdCountry=" + cmbCountry.SelectedItem.Value + "&IdCurrency=" + cmbCurrencyControl.SelectedItem.Value;
        }
        else
        {
            url = url + "DisplayedData=" + cmbDisplayedData.SelectedItem.Value + "&AmountScale=" + item.Value +
    ...
    <table style="width: 98%; margin-top: 40px;">
        <tr>
            <td style="width:40%" align="left">
				...
				<radC:RadComboBox ID="cmbCurrency" runat="server" AutoPostBack="false" 
