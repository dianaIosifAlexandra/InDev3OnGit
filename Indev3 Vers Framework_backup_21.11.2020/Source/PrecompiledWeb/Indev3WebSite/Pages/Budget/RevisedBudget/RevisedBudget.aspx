<%@ page language="C#" masterpagefile="~/Template.master" autoeventwireup="true" inherits="Pages_Budget_RevisedBudget_RevisedBudget, App_Web_uhil5dea" title="INDev3" enableeventvalidation="false" %>
...
<asp:Content ID="ph" ContentPlaceHolderID="ph" runat="Server">
      ...
      function ConfirmTabChanged(sender, eventArgs)
      {
       var inputs = document.getElementsByTagName('input');
        ...
        function ComboChange(item)
        {
            ...
            if (<%= cmbCurrency.ClientID%> !== undefined && <%= cmbCurrency.ClientID%> != null)
            {
                controlCmbCurrency = <%= cmbCurrency.ClientID%>;
            }

            if (controlCmbCurrency != null &&  controlCmbCurrency.SelectedItem.Value != null)
            {
                url = url + "AmountScale=" + item.Value + "&IdCountry=" + cmbCountry.SelectedItem.Value + "&IdCurrency=" + controlCmbCurrency.SelectedItem.Value;
            }
            else
            {
        ...
        function CountryComboChange(item)
        {
            ...
            if (controlCmbCurrency != null &&  controlCmbCurrency.SelectedItem.Value != null)
            {
                url = url + "AmountScale=" + cmbAmountScale.SelectedItem.Value + "&IdCountry=" + item.Value+ "&IdCurrency=" + controlCmbCurrency.SelectedItem.Value;
            }
            else
            {
                url = url + "AmountScale=" + item.Value + "&IdCountry=" + cmbCountry.SelectedItem.Value;        
    ...
    <table width="98%" class="tabbedNoImage backgroundColorIE">
        <tr>
            <td colspan="3">
                <radTS:RadMultiPage ID="MultiPageContainer" runat="server" Width="100%" SelectedIndex="0">
                    <radTS:PageView ID="tabHours" runat="server" Width="100%">
                        <table cellpadding="0px" cellspacing="0px" align="center" style="padding-top: 20px;">
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td align="right" style="padding-top: 0px;">
                                    <asp:Panel runat="server" ID="pnlTotalsHours" CssClass="TotalsPanel">
                                        <table cellspacing="0px;" width="100%">
                                            <tr>
                                                <td align="left" style="width:386px;">
                                                    <ind:IndLabel runat="server" ID="lblTotal1" Text="Total" style="margin-left:63px"></ind:IndLabel>
                                                </td>
                                                <td align="center">
                    ...
                    <radTS:PageView ID="tabCostsSales" runat="server" Width="100%">
                        <table cellpadding="0px" cellspacing="0px" align="center" style="padding-top: 20px;">
                            ...
                            <tr>
                                <td align="right" style="padding-top: 0px;">
                                    <asp:Panel runat="server" ID="pnlTotalsCostsSales" CssClass="TotalsPanel">
                    ...
                    <radTS:PageView ID="tabValidation" runat="server" Width="100%">
                        <table cellpadding="0px" cellspacing="0px" align="center" style="padding-top: 20px;">
                            ...
                            <tr>
                                <td align="right" style="padding-top: 0px;">
                                    <asp:Panel runat="server" ID="pnlTotalsSummary" CssClass="TotalsPanel">
                                        <table cellspacing="0px">
                                            <tr>
