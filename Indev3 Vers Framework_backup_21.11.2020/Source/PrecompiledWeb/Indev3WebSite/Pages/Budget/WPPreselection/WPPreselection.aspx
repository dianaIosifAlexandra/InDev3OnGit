<%@ page language="C#" masterpagefile="~/Template.master" autoeventwireup="true" inherits="Pages_Budget_WPPreselection_WPPreselection, App_Web_gsfqgn4g" title="INDev3" enableeventvalidation="false" %>
                        ...
                        <tr>
                            <td>
                                <ind:IndComboBox ID="cmbActive" runat="server" CheckDirty="false" AutoPostBack="True"
                                    ...
                                    <Items>
                                        <radCb:radcomboboxitem runat="server" selected="True" text="Active" value="A">
                                        </radCb:radcomboboxitem>
                                        <radCb:radcomboboxitem runat="server" text="Inactive" value="I">
                                        </radCb:radcomboboxitem>
                                        <radCb:radcomboboxitem runat="server" text="All" value="L">
                                        </radCb:radcomboboxitem>
                                    </Items>
                                </ind:IndComboBox>
                            </td>
