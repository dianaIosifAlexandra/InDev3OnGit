...
<asp:Content ID="Content1" ContentPlaceHolderID="ph" runat="Server">
    ...
    function txtChg()
    {
        ...
        if (cmbCurrency !== undefined && cmbCurrency != null)
        {
			cmbCurrency.Disable();
        }
    ...
    function DisplayedDataComboChange(item)
    {
        ...
        if (item.Value != "0")
            if (cmbCurrency !== undefined && cmbCurrency != null  &&  cmbCurrency.SelectedItem != null)
            {
                url = url + "DisplayedData=" + item.Value + "&AmountScale=" + cmbAmountScale.SelectedItem.Value + 
						    ...
						    "&IdCountry=" + cmbCountry.SelectedItem.Value + "&IdCurrency=" + cmbCurrency.SelectedItem.Value;
            }
            else
            {
                url = url + "DisplayedData=" + item.Value + "&AmountScale=" + cmbAmountScale.SelectedItem.Value + 
    ...
    function SignificantValuesComboChange(item)
    {
        ...
        if (cmbCurrency !== undefined && cmbCurrency != null  &&  cmbCurrency.SelectedItem != null)
        {
            url = url + "DisplayedData=" + cmbDisplayedData.SelectedItem.Value + "&AmountScale=" + cmbAmountScale.SelectedItem.Value +
					    "&ShowCCsWithValues=" + item.Value + "&IdCountry=" + cmbCountry.SelectedItem.Value + "&IdCurrency=" + cmbCurrency.SelectedItem.Value;
        }
        else
        {
            url = url + "DisplayedData=" + cmbDisplayedData.SelectedItem.Value + "&AmountScale=" + cmbAmountScale.SelectedItem.Value +
    ...
    function CurrencyComboChange(item)
    {
        ...
        url = url + "DisplayedData=" + cmbDisplayedData.SelectedItem.Value + "&AmountScale=" + cmbAmountScale.SelectedItem.Value +
					"&ShowCCsWithValues=" + cmbShowCCsWithSignificantValues.SelectedItem.Value + 
					"&IdCountry=" + cmbCountry.SelectedItem.Value + "&IdCurrency=" + item.Value;
    ...
    function CountryComboChange(item)
    {
        ...
        if (cmbCurrency !== undefined && cmbCurrency != null  &&  cmbCurrency.SelectedItem != null)
        {
            url = url + "DisplayedData=" + cmbDisplayedData.SelectedItem.Value + "&AmountScale=" + cmbAmountScale.SelectedItem.Value +
					    "&ShowCCsWithValues=" + cmbShowCCsWithSignificantValues.SelectedItem.Value + 
					    "&IdCountry=" + item.Value + "&IdCurrency=" + cmbCurrency.SelectedItem.Value;
        }
        else
        {
            url = url + "DisplayedData=" + cmbDisplayedData.SelectedItem.Value + "&AmountScale=" + cmbAmountScale.SelectedItem.Value +
    ...
    <table style="width: 98%; margin-top: 40px;">
        <tr>
            <td style="width:40%" align="left">
                <ind:IndLabel ID="lblDisplayedData" runat="server" Text="Data displayed"></ind:IndLabel>
                <telerik:RadComboBox ID="cmbDisplayedData" runat="server" OnClientSelectedIndexChanged="DisplayedDataComboChange" AutoPostBack="false" OnSelectedIndexChanged="cmbDisplayedData_SelectedIndexChanged"
				...
				<telerik:RadComboBox ID="cmbCurrency" runat="server" AutoPostBack="false" 
					 OnClientSelectedIndexChanging="HandleCmbChange" OnClientSelectedIndexChanged="CurrencyComboChange" SkinsPath="~\Skins\ComboBox" Skin="Default">
				</telerik:RadComboBox>                
                <ind:IndLabel ID="lblCountry" runat="server" Text="Country"></ind:IndLabel>
                <telerik:RadComboBox ID="cmbCountry" runat="server" AutoPostBack="false" OnSelectedIndexChanged="cmbCountry_SelectedIndexChanged"
            ...
            <td style="width:35%" align="right">
                <telerik:RadComboBox ID="cmbShowCCsWithSignificantValues" runat="server" AutoPostBack="false" OnClientSelectedIndexChanging="HandleCmbChange"
                    ...
                    <Items>
                        <telerik:radcomboboxitem ID="Radcomboboxitem2" runat="server" text="Display only CCs with significant values" value="Filtered">
                        </telerik:radcomboboxitem>
                        <telerik:radcomboboxitem ID="Radcomboboxitem1" runat="server" text="Display all CCs" value="All"  >
                        </telerik:radcomboboxitem>
                    </Items>
                </telerik:RadComboBox>
        ...
        <tr>
            <td colspan="3">
                <asp:Panel runat="server" ID="pnlMain">
                    <table class="tabbedNoImage backgroundColorIE" style="width: 100%; padding-top: 20px;">
                        <tr>
                            <td colspan="3">
                                                ...
                                                <table cellspacing="0px" width="100%">
                                                    <tr>
                                                        <td align="left" style="width: 439px;">
                                                            <ind:IndLabel runat="server" ID="lblTotal" Text="Total" style="padding-left:32px"></ind:IndLabel>
                                                        </td>
                                                        <td align="center" style="width: 72px;">
                                                            <ind:IndFormatedLabel runat="server" ID="lblPreviousTotals" CssClass="IndGridPagerLabel"></ind:IndFormatedLabel>
                                                        </td>
                                                        <td align="center" style="width: 72px;">
                                                            <bgt:IndReforecastBudgetVarLabel runat="server" ID="lblCurrentPreviousDiffTotals"
                                                                Width="72px" CssClass="IndGridPagerLabel"></bgt:IndReforecastBudgetVarLabel>
                                                        </td>
                                                        <td align="center" style="width: 72px;">
                                                            <ind:IndFormatedLabel runat="server" ID="lblCurrentTotals" Width="72px" CssClass="IndGridPagerLabel"></ind:IndFormatedLabel>
                                                        </td>
                                                        <td align="center" style="width: 72px;">
                                                            <bgt:IndReforecastBudgetVarLabel runat="server" ID="lblNewCurrentDiffTotals" Width="72px"
                                                                CssClass="IndGridPagerLabel"></bgt:IndReforecastBudgetVarLabel>
                                                        </td>
                                                        <td align="center" style="width: 72px;">
                                                            <ind:IndFormatedLabel runat="server" ID="lblNewTotals" Width="72px" CssClass="IndGridPagerLabel"></ind:IndFormatedLabel>
                                                        </td>
                                                        <td align="center" style="width: 72px;">
                                                            <bgt:IndReforecastBudgetVarLabel runat="server" ID="lblNewRevisedDiffTotals" Width="72px"
                                                                CssClass="IndGridPagerLabel"></bgt:IndReforecastBudgetVarLabel>
                                                        </td>
                                                        <td align="center" style="width: 72px;">
                                                            <ind:IndFormatedLabel runat="server" ID="lblRevisedTotals" Width="72px" CssClass="IndGridPagerLabel"></ind:IndFormatedLabel>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </asp:Panel>
                        ...
                        <tr>
                            ...
                            <td align="center" style="width: 33%; padding-bottom: 50px">
