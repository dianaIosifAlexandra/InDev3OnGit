<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WorkPackageEdit.ascx.cs"
    Inherits="UserControls_WorkPackage_WorkPackageEdit" %>
...
<cc2:GenericEditControl ID="WP" runat="server">
    <table border="0">
        <tbody>
            ...
            <tr>
                <td align="right">
                    <cc3:IndCatLabel ID="lblStartdate" runat="server" Text="Start Date" CssClass="IndCatLabel"></cc3:IndCatLabel>
                </td>
                <td align="left">
                    <cc1:IndCatYearMonth ID="ucStartDate" runat="server" EntityProperty="StartYearMonth" />
                </td>
            </tr>
            <tr>
                <td align="right">
                    <cc3:IndCatLabel ID="lblEndDate" runat="server" Text=" End Date" CssClass="IndCatLabel"></cc3:IndCatLabel></td>
                <td align="left">
                    <cc1:IndCatYearMonth ID="ucEndDate" runat="server" EntityProperty="EndYearMonth" />
                </td>
            </tr>
        </tbody>
    </table>
