...
<body style="background: #626262 url('../../Images/back_popup.png') no-repeat right bottom;"
    onload="SetPopUpHeight();ButtonLoseFocus()">
     ...
     <div>
       ...
       <br />      
        ...
        <table cellspacing="5" width="100%" border="0">
            ...
            <tr>
                <td align="center">
                 <table class="tabbed" cellpadding="7" cellspacing="7">
                    <tr>
                        <td>
                        ...
                        <MasterTableView EditMode="InPlace" AutoGenerateColumns="False" TableLayout="fixed"                        
