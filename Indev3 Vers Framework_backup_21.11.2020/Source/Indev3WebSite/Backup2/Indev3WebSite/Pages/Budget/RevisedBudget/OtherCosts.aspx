                ...
                <tr>
                    ...
                    <td colspan="2" align="left" style="width: 50%;">
                        ...
                        <asp:RangeValidator
                                ...
                                ValidationGroup="OtherCosts">*</asp:RangeValidator>
                        ...
                        <asp:CompareValidator ID="cmpTE" runat="server" ControlToValidate="txtUpdateTE" ForeColor="#626262"
                            Type="Double" ValidationGroup="OtherCosts" ErrorMessage="InProgress T&E must be positive." Operator="GreaterThanEqual">*</asp:CompareValidator>
                        <asp:CompareValidator ID="cmpProtoParts" runat="server" ControlToValidate="txtUpdateProtoParts"
                            ForeColor="#626262" Type="Double" ValidationGroup="OtherCosts" ErrorMessage="InProgress Proto Parts must be positive." Operator="GreaterThanEqual">*</asp:CompareValidator>
                        <asp:CompareValidator ID="cmpProtoTooling" runat="server" ControlToValidate="txtUpdateProtoTooling"
                            ForeColor="#626262" Type="Double" ValidationGroup="OtherCosts" ErrorMessage="InProgress Proto Tooling must be positive." Operator="GreaterThanEqual">*</asp:CompareValidator>
                        <asp:CompareValidator ID="cmpTrials" runat="server" ControlToValidate="txtUpdateTrials"
                            ForeColor="#626262" Type="Double" ValidationGroup="OtherCosts" ErrorMessage="InProgress Trials must be positive." Operator="GreaterThanEqual">*</asp:CompareValidator>
                        <asp:CompareValidator ID="cmpOtherExpenses" runat="server" ControlToValidate="txtUpdateOtherExpenses"
                            ForeColor="#626262" Type="Double" ValidationGroup="OtherCosts" ErrorMessage="InProgress Other Expenses must be positive." Operator="GreaterThanEqual">*</asp:CompareValidator></td>
                </tr>
            </table>
