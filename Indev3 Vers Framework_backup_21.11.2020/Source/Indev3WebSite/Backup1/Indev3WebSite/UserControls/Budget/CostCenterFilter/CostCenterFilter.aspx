...
<body style="background: #626262 url('../../../Images/back_popup.png') no-repeat right bottom; text-align: center;" onload="SetPopUpHeight();">
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <asp:RequiredFieldValidator ID="reqCostCenter" runat="server" ErrorMessage="Cost Center is required."
                        ControlToValidate="cmbCostCenter" ForeColor="#626262" ValidationGroup="CCFValidationGroup">*</asp:RequiredFieldValidator>
                </td>
            </tr>
