...
public partial class UserControls_DataUpload_Upload_DataLogs : GenericUserControl
{
    #region Properties
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            SessionManager.SetSessionValue((IndBasePage)this.Page, SessionStrings.VIEW_CONTROL, ApplicationConstants.MODULE_DATA_LOGS);
            SessionManager.SetSessionValue((IndBasePage)this.Page, SessionStrings.EDIT_CONTROL, ApplicationConstants.MODULE_DATA_LOGS);

            //Set grid properties
            grdLogs.EntityType = typeof(DataLogs);
    ...
    public override void SetViewEntityProperties(IGenericEntity entity)
    {
        ...
        if (currentUser.GetPermission(ApplicationConstants.MODULE_DATA_LOGS, Operations.View) == Permissions.Restricted)
        {
            base.SetViewEntityProperties(entity);
            ((DataLogs)entity).CountryCode = ((CurrentUser)SessionManager.GetSessionValueRedirect((IndBasePage)this.Page, SessionStrings.CURRENT_USER)).CountryCode;
        }
        base.SetViewEntityProperties(entity);
    }
    protected override void OnLoad(EventArgs e)
    {
        ...
        grdLogs.UserCanDelete = currentUser.GetPermission(moduleCode, Operations.ManageLogs) == Permissions.All;
