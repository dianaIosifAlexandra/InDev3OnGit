<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectUserCountry.aspx.cs"
    Inherits="Pages_Authorization_SelectUserCountry" %>
...
<body style="background: #626262; text-align: center;" onload="SetPopUpHeight();">
    <form id="form1" runat="server" onkeypress="return PreventFormValidationOnKeyPress();">
        <div>
            <table cellpadding="6px">
                <tr>
                    <td colspan="2">
                        <cc1:IndLabel ID="lblTitle" runat="server" Text="Your are registered in two or more countries. Please select one country."></cc1:IndLabel>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left">
                        ...
                        <asp:RequiredFieldValidator ID="reqCountry" runat="server" ControlToValidate="cmbCountries"
                            ErrorMessage="Country is required." ForeColor="#626262">*</asp:RequiredFieldValidator></td>
                </tr>
                <tr>
                    <td colspan="2">
