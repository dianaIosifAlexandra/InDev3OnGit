<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectCoreTeamMember.aspx.cs"
    Inherits="UserControls_Budget_ProjectCoreTeamMember_SelectCoreTeamMember" %>
...
<body style="background: #626262 url('../../../Images/back_popup.png') no-repeat right bottom;" onload="SetPopUpHeight();">
        ...
        <div style="padding-left:15px;">
            <table>
                <tr>
                    ...
                    <td align="left">
                        <asp:Label ID="Label2" runat="server" ForeColor="#626262" Text="*"></asp:Label>
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <asp:RequiredFieldValidator ID="RFV1" runat="server" ErrorMessage="Associate is required."
                            ForeColor="#626262" ControlToValidate="cmbAs">*</asp:RequiredFieldValidator></td>
                </tr>
                <tr>
